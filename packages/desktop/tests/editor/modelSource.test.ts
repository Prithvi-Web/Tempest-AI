...
import { MODEL_DEADLINE_MS, modelBackedSource } from "../../../platform/client/tempest/views/editor/modelSource";
...
vi.mock("../../src/generated/bindings", () => ({
  commands: {
...
describe("the default source — the one product code uses", () => {
  it("unwraps the binding's Result, and treats an error as no completion", async () => {
    const { commands } = await import("../../src/generated/bindings");
